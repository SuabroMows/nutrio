...
function AppComponent_tr_46_Template(rf, ctx) { if (rf & 1) {
...
class AppComponent {
    ...
    nextQuestion() {
        if (this.questions.length > this.currentQuestion + 1) {
            ...
            for (const item of _questons__WEBPACK_IMPORTED_MODULE_1__["questions"]) {
                let index = -1;
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 47, vars: 11, consts: [[1, "text-center"], [1, "main-box"], [3, "hidden"], [1, ""], [1, "decript-box"], [3, "formGroup"], ["class", "form-check text-question", 4, "ngFor", "ngForOf"], [1, "btn-answer"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"], [1, "table"], ["scope", "col"], [4, "ngFor", "ngForOf"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "form-check", "text-question"], ["type", "radio", "formControlName", "answer", 1, "form-check-input", 3, "value"], [1, "form-check-label"], ["scope", "row"], [2, "text-align", "right"], [2, "text-align", "center"], [3, "ngClass"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_14_listener() { return ctx.nextQuestion(); });
...
module.exports = __webpack_require__(/*! C:\Users\SubaroMows\Documents\projects\nutrio\src\main.ts */"./src/main.ts");
