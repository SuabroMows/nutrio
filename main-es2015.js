...
/* harmony import */ var _questons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./questons */ "./src/app/questons.ts");
...
const htmlToPdfmake = __webpack_require__(/*! html-to-pdfmake */ "./node_modules/html-to-pdfmake/index.js");
...
class AppComponent {
    ...
    nextQuestion() {
        if (this.form.value.q.length > this.currentQuestion + 1) {
            ...
            for (const item of this.form.value.q) {
                let index = -1;
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 57, vars: 11, consts: [[1, "text-center"], [1, "form-select", 3, "change"], ["value", "1"], ["value", "2"], ["value", "3"], [1, "main-box"], [3, "hidden"], [1, ""], [1, "decript-box"], [3, "formGroup"], ["class", "form-check text-question", 4, "ngFor", "ngForOf"], [1, "btn-answer"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"], ["id", "pdfTable", 3, "hidden"], ["pdfTable", ""], [1, "table"], ["scope", "col"], [4, "ngFor", "ngForOf"], [3, "ngClass", 4, "ngFor", "ngForOf"], [1, "btn", "btn-info", 3, "click"], [1, "form-check", "text-question"], ["type", "radio", "formControlName", "answer", 1, "form-check-input", 3, "value"], [1, "form-check-label"], ["scope", "row"], [2, "text-align", "right"], [2, "text-align", "center"], [3, "ngClass"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h3", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "select", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AppComponent_Template_select_change_1_listener($event) { return ctx.selectQuestionary($event.target.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_20_listener() { return ctx.nextQuestion(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_55_listener() { return ctx.downloadAsPDF(); });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "questions2", function() { return questions2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "questions3", function() { return questions3; });
const questions = [
    {
        id: 1,
...
module.exports = __webpack_require__(/*! C:\Users\SubaroMows\Documents\projects\ddcp-git\Nutrio\src\main.ts */"./src/main.ts");
